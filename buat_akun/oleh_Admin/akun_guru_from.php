...
if (!isset($_SESSION['temp_guru'])) {
    echo "<script>alert('Silahkan isi profil terlebih dahulu!'); window.location='index_Admin.php?page=anggota_guru_from';</script>";
    exit();
}
...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark"><i class="fas fa-user-plus mr-2 text-primary"></i>Buat Akun untuk Guru :</h1>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="col-12">
                ...
                <div class="info-box shadow-sm mb-3 bg-white border-left border-primary">
                    ...
                    <div class="info-box-content">
                        ...
                        <h4 class="info-box-number font-weight-bold mb-0"><?php echo strtoupper($data['Nama_guru']); ?></h4>
                        <span class="text-sm text-primary">NIP: <?php echo $data['NIP']; ?></span>
                    </div>
                </div>
                ...
                <div class="card card-primary card-outline shadow">
                    ...
                    <form action="buat_akun/akun_proses.php" method="POST">
                        <div class="card-body">
                            <p class="text-muted mb-4">Silahkan tentukan username dan password yang akan digunakan oleh guru untuk login ke aplikasi.</p>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="username" class="form-control form-control-lg" 
                                        placeholder="Masukan Username Guru" required autocomplete="off">
                                </div>
                        ...
                        <div class="card-footer bg-transparent py-3">
                            <div class="row">
                                <div class="col-md-6 mb-2 mb-md-0">
                                    <a href="index_Admin.php?page=anggota_guru_from" class="btn btn-default btn-block">
